...
namespace Authentication
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AppDbContext>(setup => setup.UseSqlServer(Configuration.GetConnectionString("con")));

            services.AddScoped<IRepository<MemberDTO>, GenenricRepository<MemberDTO>>();
